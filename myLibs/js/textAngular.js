    ...
    */
    ...
    angular.module("textAngularSetup", []).constant("taRegisterTool", c).value("taTools", e).value("taOptions", {
        ...
        toolbar: [
            ...
            ["justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "indent", "outdent", "file"],
                ...
                action: function() {
                  ...
                  function getBase64(file) {
                     ...
                     reader.onload = function () {
                        var base64;
                        if( base64 = reader.result, base64 && "" !== base64 && "http://" !== base64 && !l(base64) ) {
                            d.getSelectionElement().tagName && "a" === d.getSelectionElement().tagName.toLowerCase() &&
                                d.setSelectionAfterElement(d.getSelectionElement());
                            var e = '<img src="' + base64 + '">';
                            return _self.$editor().wrapSelection("insertHTML", e, !0)
                        }
                     };
                  }
                  document.getElementById("upload-img").onchange = readFile;
        ...
        return {
            ...
            link: function(f, r, u, v) {
                ...
                if (
                    ...
                    r.attr("required") && (B.$validators.required = function(a, b) {
                        return !p(a || b)
                    }),
                    // parsers trigger from the above keyup function or any other time that the viewValue is updated and parses it for storage in the ngModel
                    B.$parsers.push(ea), B.$parsers.unshift(W),
                    // because textAngular is bi-directional (which is awesome) we need to also sanitize values going in from the server
                    B.$formatters.push(ea), B.$formatters.unshift(W), B.$formatters.unshift(function(a) {
                                ...
                                if (a && a.trim().length) {
                                    ...
                                    if (a.match(/class=["']*Mso(Normal|List)/i) || a.match(/content=["']*Word.Document/i) || a.match(/content=["']*OneNote.File/i)) {
                                        ...
                                        angular.forEach(i.find("span"), function(a) {
                                            ...
                                            }), angular.forEach(i.find("font"), u), a = i.html(), d && (a = i.html() || g.html()),
                        ...
                        f.$watch(u.taReadonly, function(a, b) {
                            b !== a && (a ? (r.addClass("ta-readonly"),
                                ...
                                angular.forEach(j, function(a) {
                                    r.find(a).on("click", $)
                                }), r.off("drop", oa)) : (r.removeClass("ta-readonly"),
                                // we changed to NOT readOnly mode (taReadonly='false')
                                "textarea" === r[0].tagName.toLowerCase() || "input" === r[0].tagName.toLowerCase() ? r.removeAttr("disabled") : D && r.attr("contenteditable", "true"),
        ...
        return {
            ...
            link: function(g, h, i) {
                ...
                var j = function(b, c) {
                    ...
                    if(b.tooltiptext === "Upload") {
                      var d;
                      if (d = b && b.display ? angular.element(b.display) : angular.element("<input type='file' id='upload-img'>"), b && b.class ? d.addClass(b.class) : d.addClass(g.classes.toolbarButton), d.attr("name", c.name),
